**I am...**{: style="font-size:1.05em;margin-right:1.1em"} an incoming researcher at OpenAI. I do machine learning research on **learned representations, decision-making, and reasoning**{: style="font-weight:600"}.
...
**Research.**{: style="font-size:1.05em;margin-right:1.1em"} I am interested in the two intertwined paths towards **generalist agents**: (1) agents (pre)trained for multi-task (2) agents that can adaptively solve new tasks. I believe that representation is the key that connects learning, adaptation, and capabilities.
...
**Misc.**{: style="font-size:1.05em;margin-right:1.1em"} I was a core <span style="font-weight:500;padding-left:0.1em"><img style="height:1.4em;padding-bottom:0.2em" src="https://pytorch.org/assets/images/logo-icon.svg"/> PyTorch</span> dev (ver. 0.2-1.2), coded some open-source machine learning projects [![GitHub User's stars](https://img.shields.io/github/stars/ssnl?affiliations=OWNER%2CCOLLABORATOR&logo=github&label=stars){: style="height: 1.1em;vertical-align:text-bottom"}](/open-source/), co-developed MIT's [*6.s898 Deep Learning*](https://phillipi.github.io/6.s898/2022/index.html), and mentored [SGI](https://summergeometry.org/sgi2023/a-study-on-quasimetric-reinforcement-learning/) students. I host [pro bono office hours](./pro-bono-office-hours/) as much as I can. I love coffee ☕, travelling, 
and my 😸😼.
